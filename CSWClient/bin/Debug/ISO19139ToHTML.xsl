...
2011-10-17 SMR simplified so just does ISO19139 for USGIN
-->

  <xsl:import href = "Imports\general.xslt" />
  <xsl:import href = "Imports\ISO19139.xslt" />
  ...
  <xsl:variable name="iso19139" select="(local-name(/*) = 'MD_Metadata') or (local-name(/node()[1]/node()[1]) = 'MD_Metadata')" />
