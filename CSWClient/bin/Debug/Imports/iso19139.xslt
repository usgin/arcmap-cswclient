			...
			<dd>
				<dl>
					...
					<xsl:for-each select="gmd:city">
						<dt>
							<span class="element"> City </span>&#x2003;<xsl:call-template name="CharacterString"/>
						</dt>
					</xsl:for-each>
					<xsl:for-each select="gmd:administrativeArea">
						<dt>
							<span class="element"> administrativeArea </span>&#x2003;<xsl:call-template name="CharacterString"/>
						</dt>
					</xsl:for-each>
					<xsl:for-each select="gmd:postalCode">
						<dt>
							<span class="element"> postalCode </span>&#x2003;<xsl:call-template name="CharacterString"/>
						</dt>
					</xsl:for-each>
					<xsl:for-each select="gmd:country">
						<dt>
